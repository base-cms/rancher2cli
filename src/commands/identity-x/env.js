...
module.exports = cleanEnv(process.env, {
  ...
  GRAPHQL_VERSION: nonemptystr({ desc: 'The service workload version to deploy', default: '0.0.0' }),
  MANAGE_VERSION: nonemptystr({ desc: 'The service workload version to deploy', default: '0.0.0' }),
  ...
  SERVICE_VERSION: nonemptystr({ desc: 'The service workload version to deploy', default: '0.0.0' }),
